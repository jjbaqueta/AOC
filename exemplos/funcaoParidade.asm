# Exercício
# Implemente uma função chamada ePar que recebe, por parâmetro, um número inteiro. 
# Essa função deve retornar 1 se o número informado for par, ou 0 caso seja ímpar. 
